...
$meta_id = get_post_meta(get_the_ID());
	$slider_query_args = array(
		...
		'tax_query'        => array(
			array(
				'taxonomy' => 'slides',
				'field'    => 'term_id',
				'terms'    => array('69','70', '77', '75', '76', '74', '73', '71', '72'),
				'opertor'  => 'IN'
			)),
			'meta_query' => array(
				'relation' => 'AND',
...
?>
<?php //var_dump($photo_large_left_bali ); ?>
	<?php if (wp_attachment_is_image(get_field('photo_large_left')) && !post_password_required()) {
		$portfolio_main = wp_get_attachment_image_src( get_field('photo_large_left'), $post->ID,'full' );
